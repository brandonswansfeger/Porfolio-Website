...
function Contact() {
  ...
  return (
    ...
    <m.div animate={{animation: 'fadeIn 1s'}} className="ContactBody"style={{backgroundImage: {resume_background}, backgroundSize:'cover', width:'100%', minHeight:'130vh', margin: 0, padding: 0}}>
    ...
    <div style={{display:'flex', flexGrow: 1, flexDirection:'column', justifyContent:'start',alignItems:'center', height:'100vh', paddingBottom: '10%'}}>
