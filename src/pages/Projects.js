        ...
        return (
                      ...
                      <p style={{fontFamily:'Federo', width: '100%', fontSize:'50px', color:'black', position: 'relative', paddingLeft: 'auto', paddingRight: 'auto', textAlign: 'center', lineHeight: '1', paddingTop: '34px', backgroundColor: 'turquoise', zIndex: 1, marginTop: '15px'}}>Projects</p>
                                ...
                                <div className="ProjectCard">
                                        ...
                                        <p style={{ fontSize: 'small', height: '13%', color: 'black', width: '90%', textAlign: 'center', justifySelf: 'top', justifyContent: 'flexStart', fontWeight: 'light', marginTop: '5px', marginBottom: '34px' }}>Fetch external data based on user input and display/render bar chart showing GDP & TFR for all countries</p>
  ...
  target="_blank" data-maxbuttoncounter="{&quot;button_id&quot;:204038,&quot;url&quot;:&quot;[empty]&quot;}" data-maxbuttonpage="{&quot;id&quot;:false,&quot;type&quot;:false}"><div className='buttonText' >Demo</div></a>
   ...
   <div className="ButtonLink2">
                                ...
                                <div className="ProjectCard">
                                        ...
                                        {/* <p style={{ fontSize: 'medium', lineHeight: '22px', color: 'black', width: '90%', textAlign: 'center', justifySelf: 'top', fontWeight: 'bold', justifyContent: 'flexStart', marginTop: '20px', marginBottom: '-5px' }}></p> */}
                                        <p style={{ fontSize: 'small', height: '13%', color: 'black', width: '90%', textAlign: 'center', justifySelf: 'top', justifyContent: 'flexStart', fontWeight: 'light', marginTop: '5px', marginBottom: '34px' }}>VCard / QR Code Generator and Online Business Directory</p>
