...
const AboutMe = (props) => {
  return (
    ...
    <div className="AboutBody justify-content-center" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', background: 'linear-gradient(#000428, #004E92)', minHeight: '100vh', backgroundAttachment: 'fixed' }} >
    ...
    <div className="justify-content-center lowerBody" style={{minWidth: '350px', height: 'auto', display: 'flex',marginTop: '8rem', maxWidth: '900px', flexDirection: 'row', flexWrap: 'wrap',  }} initial={{ opacity: 0 }} animate={{ animation: 'fadeInRightBig 2s ease', animationFillMode: 'before', opacity: 1 }}>
      <m.p style={{ fontFamily: 'Federo', fontSize: '50px', color: 'turquoise', marginBottom: '1%',  textAlign: 'center', width: '100%' }}>About Me</m.p>  
